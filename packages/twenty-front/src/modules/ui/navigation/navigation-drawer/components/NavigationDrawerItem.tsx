...
const COLORED_ICONS = {
  IconBuildingSkyscraper: 'blue', // Companies
  IconNotes: 'yellow', // Notes
  IconTargetArrow: 'green', // Opportunities
  IconUser: 'purple', // People
  IconCheckbox: 'turquoise', // Tasks
  IconSettings: 'turquoise', // Workflow Runs
  IconSettingsAutomation: 'pink', // Workflows
  // Новые иконки
  IconUserCircle: 'purple', // Пользовательский профиль
  IconColorSwatch: 'pink', // Цветовая палитра
  IconAt: 'blue', // Email/Mention
  IconMail: 'orange', // Почта
  IconCalendarEvent: 'green', // Календарь
  IconUsers: 'turquoise', // Группы пользователей
  IconHierarchy2: 'yellow', // Иерархия
  IconApps: 'purple', // Приложения
  IconKey: 'red', // Ключ/Доступ
  IconCode: 'blue', // Код
  IconRocket: 'orange', // Запуск
  IconDoorEnter: 'grey', // Вход
  IconTable: 'turquoise', // Таблица
};
...
export const NavigationDrawerItem = ({
  ...
  const _isSettingsPage = useIsSettingsPage();
  ...
  const getIconColor = () => {
    ...
    if (typeof Icon !== 'undefined') {
      // Получаем имя функции иконки
      const iconName = Icon.displayName || Icon.name;
      console.log('Icon info:', { Icon, iconName });

      if (typeof iconName === 'string') {
        const colorName = COLORED_ICONS[iconName as keyof typeof COLORED_ICONS];
        console.log('Color info:', {
          iconName,
          colorName,
          availableColors: Object.keys(COLORED_ICONS),
        });
